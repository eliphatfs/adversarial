...
def parse_args():
    ...
    parser.add_argument('--attacker', choices=['pgd', 'fw'], default='fw')
...
if __name__ == '__main__':
    ...
    if args.attacker == 'fw':
        print('Using Sobol Happy Attack', file=sys.stderr)
        attack = SobolHappyAttack(args.step_size, args.epsilon, args.perturb_steps)
    else:
