...
if __name__ == '__main__':
    ...
    if args.model_name != "":
        model = get_model_for_attack(args.model_name).to(
            device)   # 根据model_name, 切换要攻击的model
    ...
    print(
        f"Natural Acc: {natural_acc:.5f}, Robust acc: {robust_acc:.5f}, distance:{distance:.5f}")
